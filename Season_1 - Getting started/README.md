...
#### `Day 22`
[`back to top`](#66DaysOfData)
- Started working on News Headline Tag Prediction model. Currently it is overfitting ! Improvement needed.

<br/>--------------------------------------------------------------------------------------------------------------<br/>

#### `Day 23`
[`back to top`](#66DaysOfData)
- Completed News Headline Tag Prediction modelling. Got accuracy of `94%` with loss in range `0.3-0.5`. I stopped training now. Start writing blog-post for this model.
 
<br/>--------------------------------------------------------------------------------------------------------------<br/>

#### `Day 24`
[`back to top`](#66DaysOfData)
- Start Learning Django .... from Youtube channel [`code with harry`](https://www.youtube.com/watch?v=JxzZxdht-XY)
...
- Continue doing Stanford's Machine Learning Couse by Andrew Ng.
...
- Doing Week 9 of ML Course by Andrew Ng
<br/>--------------------------------------------------------------------------------------------------------------<br/>
...
### `Day 54` 
[`back to top`](#66DaysOfData)
- Gave some Assessment on Workera 

<br/>--------------------------------------------------------------------------------------------------------------<br/>

### `Day 55` 
[`back to top`](#66DaysOfData)
- Learned maths involved in linear and logistic regression.

<br/>--------------------------------------------------------------------------------------------------------------<br/>

### `Day 56` 
[`back to top`](#66DaysOfData)
- Learned maths behind neural networks ( FNN-feed forward neural network & Backpropagation + Gradient Descent ) 

<br/>--------------------------------------------------------------------------------------------------------------<br/>

### `Day 57` 
[`back to top`](#66DaysOfData)
- Learned maths behind SVMs (for classification). 
...
### `Day 59` 
[`back to top`](#66DaysOfData)
- learn plotting Japanese Candlesticks in Excel Sheets. 
...
### `Day 63` 
[`back to top`](#66DaysOfData)
- I am revising my linear algebra concepts which includes vectors spaces and its properties, orthogonality, projections, some useful theorems (including SVD and null nullity theorem) with proofs and also basic probability required for machine learning.
